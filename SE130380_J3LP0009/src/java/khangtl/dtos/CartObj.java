...
public class CartObj implements Serializable {
    ...
    public ResourceDTO getItemById(int id) {
        ResourceDTO dto = null;
        for (Map.Entry<ResourceDTO, Integer> entry : this.items.entrySet()) {
    ...
    public void addItemToCart(ResourceDTO dto, int amount) {
        if (this.items == null) {
    ...
    public void updateItemCart(ResourceDTO dto, int amount) {
        if (this.items == null) {
            this.items = new HashMap<>();
        }
        if (this.items.containsKey(dto)) {
    ...
    public void removeItemFromCart(ResourceDTO dto) {
        if (this.items == null) {
            return;
        }
        if (this.items.containsKey(dto)) {
