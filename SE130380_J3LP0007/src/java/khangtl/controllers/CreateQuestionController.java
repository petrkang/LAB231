    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (valid) {
                ...
                if (beans.checkExistQuestion()) {
                    request.setAttribute("ERROR", "This question is existed, please try again");
                } else {
                    ...
                    answerList.add(ans3);
                    answerList.add(ans4);
                    dto = new QuestionDTO(cont, "Active", subject, answerList);
                    beans.setDto(dto);
                    if (beans.insertQuestion()) {
                        request.setAttribute("SUCCESS", "Create question successfully");
                    } else {
                        request.setAttribute("ERROR", "Create question failed");
            ...
            request.getRequestDispatcher("NewQuestionController").forward(request, response);
        }
    }
